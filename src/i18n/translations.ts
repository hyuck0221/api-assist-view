...
const en = {
  ...
  'sourceForm.endpointHint': (baseUrl: string, basePath: string) =>
    `Base path: ${baseUrl || '<baseUrl>'}${basePath || '/api/logs'} · Set the base path in your Spring Boot app to match.`,
  'sourceForm.apiDocsEndpointHint': (baseUrl: string, basePath: string) =>
    `Base path: ${baseUrl || '<baseUrl>'}${basePath || '/api/documents'} · Ensure the API Docs feature is enabled in your app.`,
  ...
  'settings.apiRef.description': 'When using an API source, your application must implement the following endpoints. Default base path is "/api/logs" for log sources and "/api/documents" for API Docs.',
  'settings.apiRef.logs': 'Log List (Paginated)',
  'settings.apiRef.stats': 'Log Statistics',
  'settings.apiRef.apps': 'App Name List',
  'settings.apiRef.files': 'Log File List',
  'settings.apiRef.filesContent': 'Log File Content',
  'settings.apiRef.receive': 'Receive External Logs',
  'settings.apiRef.docsStatus': 'API Docs Status',
  'settings.apiRef.docsCats': 'API Docs Categories',
  'settings.apiRef.docsList': 'API Docs List (Paginated)',
  'settings.apiRef.mcpSse': 'MCP SSE Connection',
  'settings.apiRef.mcpHttp': 'MCP HTTP Connection',
  'settings.apiRef.viewDocs': 'View library documentation',

  'settings.mcpGuide.title': 'MCP Connection Guide',
  'settings.mcpGuide.description': 'Connect your AI assistant to the API Assist server via MCP (Model Context Protocol). Use SSE for real-time streaming or HTTP for standard requests.',
  'settings.mcpGuide.cursor.title': 'Cursor',
...
const ko: typeof en = {
  ...
  'sourceForm.endpointHint': (baseUrl: string, basePath: string) =>
    `기본 경로: ${baseUrl || '<baseUrl>'}${basePath || '/api/logs'} · Spring Boot 앱의 기본 경로 설정과 일치해야 합니다.`,
  'sourceForm.apiDocsEndpointHint': (baseUrl: string, basePath: string) =>
    `기본 경로: ${baseUrl || '<baseUrl>'}${basePath || '/api/documents'} · 앱에서 API 문서 기능이 활성화되어 있는지 확인하세요.`,
  ...
  'settings.apiRef.description': 'API 소스를 사용할 때, 애플리케이션에 다음 엔드포인트가 구현되어 있어야 합니다. 로그 소스 기본 경로: "/api/logs", API 문서 기본 경로: "/api/documents".',
  'settings.apiRef.logs': '로그 목록 (페이징)',
  'settings.apiRef.stats': '로그 통계',
  'settings.apiRef.apps': '앱 이름 목록',
  'settings.apiRef.files': '로그 파일 목록',
  'settings.apiRef.filesContent': '로그 파일 내용',
  'settings.apiRef.receive': '외부 로그 수신',
  'settings.apiRef.docsStatus': 'API 문서 활성화 상태',
  'settings.apiRef.docsCats': 'API 문서 카테고리 목록',
  'settings.apiRef.docsList': 'API 문서 목록 (페이징)',
  'settings.apiRef.mcpSse': 'MCP SSE 연결',
  'settings.apiRef.mcpHttp': 'MCP HTTP 연결',
  'settings.apiRef.viewDocs': '라이브러리 문서 보기',

  'settings.mcpGuide.title': 'MCP 연결 가이드',
  'settings.mcpGuide.description': 'MCP(Model Context Protocol)를 통해 AI 어시스턴트를 API Assist 서버에 연결하세요. SSE는 실시간 스트리밍, HTTP는 표준 요청 방식입니다.',
  'settings.mcpGuide.cursor.title': 'Cursor',
